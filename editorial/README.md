...
1. [Daily assignment library](prompts/DAILY_ASSIGNMENTS.md): short, ready-to-send prompts for daily and focused editorial runs.
2. [Reporting-agent prompt](prompts/REPORTING_AGENT.md): the operational prompt used for autonomous news discovery or a directed story lead.
3. [Content strategy](CONTENT_STRATEGY.md): the approved Signal → Stakes → Follow-through model, story-selection gate, and angle framework.
4. [Agent submission contract](AGENT_SUBMISSION_CONTRACT.md): the files and fields required in every submission.
5. [Reporting and quality rules](REPORTING_AND_QUALITY_RULES.md): the evidence, writing, image, safety, and review standards every draft must meet.
6. [Writing style](WRITING_STYLE.md): the Akan Reports voice and the required anti-slop editing pass for public copy.
