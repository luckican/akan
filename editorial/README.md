...
Both documents are normative for the MVP. If an example story conflicts with them, these documents take precedence.
...
The prompt tells the agent to load the contract, reporting rules, and content model from the repository; their full text does not need to be pasted into every assignment.
