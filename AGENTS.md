...
- Public editorial copy must pass the house-style check in `editorial/WRITING_STYLE.md` after factual verification. For straight news and Signals, default to restrained factual narration: put the verified development first, attribute claims plainly, add only the context needed to understand them, and let the sequence of facts carry the significance. The publication's voice should usually be unobtrusive. Use **we** only when a genuine Akan Reports check, finding, synthesis, or evidence limit materially helps the reader. Use **you** only when it genuinely makes the reader's stake easier to understand. Neither pronoun is a house requirement.
- Do not announce analysis that the facts already show. Avoid recurring signposts such as “why this matters,” “the practical point,” “the key question,” “what this means,” “the next test,” and “what happens next” unless the wording is necessary for that specific story. Subheads should identify the actual subject or development, not the rhetorical job of the section.
- Templated language is a failed style check. Do not reuse stock openings, transitions, paragraph sequences, reader-address formulas, or endings across stories. Each article's language and structure must arise from its own reporting.
